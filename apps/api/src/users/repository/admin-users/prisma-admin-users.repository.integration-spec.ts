...
import type { IAdminUsersRepository } from './admin-users.repository.interface';

describe('PrismaAdminUsersRepository (integration)', () => {
  let moduleRef: TestingModule;
  let prisma: PrismaService;
  let repository: IAdminUsersRepository;
  ...
  beforeAll(async () => {
    ...
    repository = moduleRef.get<IAdminUsersRepository>(USERS_PROVIDER_KEYS.ADMIN_USERS_REPOSITORY);
