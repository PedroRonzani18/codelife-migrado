...
const alertVariants = cva('relative grid w-full grid-cols-[0_1fr] items-start gap-x-3 gap-y-0.5 rounded-lg border px-4 py-3 text-sm has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] has-[>svg]:[&>svg]:row-span-2 has-[>svg]:[&>svg]:mt-0.5 has-[>svg]:[&>svg]:text-current', {
  variants: {
    variant: {
